...
export default function AboutPanel () {
  return (
    ...
    >
      ...
      <p>If you find any bugs or have any ideas or suggestions, either let me know on <ExternalLink href={'http://twitter.com/beeglebug'}>twitter</ExternalLink> or raise an issue on <ExternalLink href={'http://github.com/beeglebug/tiny-little-worlds'}>github</ExternalLink> and i&apos;ll do my best!</p>
    </Panel>
  )
}
