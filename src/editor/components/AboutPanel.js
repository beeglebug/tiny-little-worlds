...
export default function AboutPanel () {
  return (
    ...
    >
      ...
      <p>If you find any bugs or have any ideas or suggestions, either let me know on <a href="http://twitter.com/beeglebug">twitter</a> or raise an issue on <a href="http://github.com/beeglebug/tiny-little-worlds">github</a> and i&apos;ll do my best!</p>
    </Panel>
  )
}
